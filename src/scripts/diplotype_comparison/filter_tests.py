...
if __name__ == "__main__":
    ...
    if args.predicted_calls:
        reference_file = Path(args.predicted_calls).resolve()
    else:
        reference_file_dir: Path = Path(globals().get("__file__", "./_")).resolve().parent
    ...
    if args.failed_tests:
        test_file = Path(args.failed_tests).resolve()
    else:
